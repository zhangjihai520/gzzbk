...
import com.ry.common.utils.DateUtil;
import com.ry.common.utils.DledcHttpUtils;
import lombok.Data;
...
public class DledcDefaultClient {
    ...
    /// <returns></returns>
    public <R extends DledcResponse, T extends IDledcRequest> R Execute(Class<R> responsClazz, T request) {
        ...
        try {
            ...
            log.error(String.format("请求云平台接口异常，参数：%s", JSON.toJSONString(request)), ex);
        }
