...
public class DateUtil {
    ...
    public static Date dateCount(Date startDate, int feeCycleNum, int feeCycleUnit) {
        ...
        if (feeCycleUnit == Constants.YEAR) {
            cal.add(Calendar.YEAR, +feeCycleNum);
        }

        if (feeCycleUnit == Constants.MONTH) {
            cal.add(Calendar.MONTH, +feeCycleNum);
        }

        if (feeCycleUnit == Constants.DAY) {
    ...
    public static LocalDate LocalDateMIN() {
        return LocalDate.parse("1970-01-01", Constants.Datefomat_yyyyMMdd);
    }

    public static LocalDate LocalDateMAX() {
        return LocalDate.parse("2999-12-31", Constants.Datefomat_yyyyMMdd);
    }

    public static LocalDateTime LocalDateTimeMIN() {
        return LocalDateTime.parse("1970-01-01 00:00:00", Constants.datefomat_nomal);
    }

    public static LocalDateTime LocalDateTimeMAX() {
        return LocalDateTime.parse("2999-12-31 23:59:59", Constants.datefomat_nomal);
    }
